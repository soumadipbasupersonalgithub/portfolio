(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function i(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(s){if(s.ep)return;s.ep=!0;const n=i(s);fetch(s.href,n)}})();const G=()=>{const e=document.getElementById("themeToggle");if(!e)return;const t=()=>localStorage.getItem("portfolio-theme")||"light",i=o=>{document.documentElement.setAttribute("data-theme",o),localStorage.setItem("portfolio-theme",o)};i(t()),e.addEventListener("click",()=>{const o=t()==="light"?"dark":"light";i(o)})};G();const z=()=>{const e=document.getElementById("scrollTop");e&&(window.addEventListener("scroll",()=>{window.scrollY>400?e.classList.add("visible"):e.classList.remove("visible")},{passive:!0}),e.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}))};z();const J=()=>{const e=document.getElementById("heroCanvas");if(!e)return;const t=e.getContext("2d");let i=[],o={x:null,y:null};const s=()=>{const d=e.parentElement;e.width=d.offsetWidth,e.height=d.offsetHeight};s(),window.addEventListener("resize",s);const n=()=>document.documentElement.getAttribute("data-theme")==="dark";class a{constructor(){this.x=Math.random()*e.width,this.y=Math.random()*e.height,this.vx=(Math.random()-.5)*.5,this.vy=(Math.random()-.5)*.5,this.r=Math.random()*2+1}update(){if(this.x+=this.vx,this.y+=this.vy,(this.x<0||this.x>e.width)&&(this.vx*=-1),(this.y<0||this.y>e.height)&&(this.vy*=-1),o.x!==null){const c=this.x-o.x,f=this.y-o.y,y=Math.sqrt(c*c+f*f);y<120&&(this.x+=c/y*1.5,this.y+=f/y*1.5)}}draw(){const c=n();t.beginPath(),t.arc(this.x,this.y,this.r,0,Math.PI*2),t.fillStyle=c?`rgba(129, 140, 248, ${.3+this.r*.15})`:`rgba(99, 102, 241, ${.25+this.r*.1})`,t.fill()}}const l=Math.min(80,Math.floor(e.width*e.height/12e3));for(let d=0;d<l;d++)i.push(new a);const g=()=>{t.clearRect(0,0,e.width,e.height);const d=n();i.forEach(c=>{c.update(),c.draw()});for(let c=0;c<i.length;c++)for(let f=c+1;f<i.length;f++){const y=i[c].x-i[f].x,w=i[c].y-i[f].y,E=Math.sqrt(y*y+w*w);E<150&&(t.beginPath(),t.moveTo(i[c].x,i[c].y),t.lineTo(i[f].x,i[f].y),t.strokeStyle=d?`rgba(129, 140, 248, ${.08*(1-E/150)})`:`rgba(99, 102, 241, ${.06*(1-E/150)})`,t.lineWidth=.5,t.stroke())}requestAnimationFrame(g)};g(),e.parentElement.addEventListener("mousemove",d=>{const c=e.getBoundingClientRect();o.x=d.clientX-c.left,o.y=d.clientY-c.top}),e.parentElement.addEventListener("mouseleave",()=>{o.x=null,o.y=null})};window.innerWidth>768&&!("ontouchstart"in window)&&J();const X=()=>{const e=document.querySelectorAll(".section-header, .about-text, .about-image, .skill-card, .certificate-card, .project-card, .contact-info, .form-section"),t=new IntersectionObserver(i=>{i.forEach(o=>{o.isIntersecting&&(o.target.classList.add("animate"),t.unobserve(o.target))})},{threshold:.1,rootMargin:"0px 0px -50px 0px"});e.forEach(i=>t.observe(i))};X();(function(){const e=document.createElement("style");e.textContent=`
    .image-card {
